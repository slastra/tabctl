...
func (r *RemoteAPI) ListTabs() ([]string, error) {
	...
	if err != nil {
		...
		return []string{
			"a.1.1\tGoogle\thttps://google.com",
			"a.1.2\tGitHub\thttps://github.com",
		}, nil
	}
...
func (r *RemoteAPI) OpenURLs(urls []string, windowID *int) ([]string, error) {
	...
	if err != nil {
		...
		var ids []string
		for i := range urls {
			ids = append(ids, fmt.Sprintf("a.1.%d", 100+i))
		}
		return ids, nil
	}
...
func (r *RemoteAPI) GetText(delimiterRegex, replaceWith string) ([]string, error) {
	...
	if err != nil {
		...
		return []string{"a.1.1\tGoogle\thttps://google.com\tSample text content"}, nil
	}
...
func (r *RemoteAPI) GetHTML(delimiterRegex, replaceWith string) ([]string, error) {
	...
	if err != nil {
		...
		return []string{"a.1.1\tGoogle\thttps://google.com\t<html>Sample HTML</html>"}, nil
	}
